...
| record old installed version | PASS | No previous registry entry found. |
| stop existing HyperBoostX processes | PASS |  |
| uninstall previous HyperBoostX | PASS | No previous install found. |
...
| launch installed HyperBoostX | PASS | pid=16000 |
...
| WPF installed smoke | PASS | [{"name":"HyperBoostX","id":16000,"path":"<INSTALL_DIR>\\HyperBoostX.exe","from_install":true},{"name":"hyperboost_backend","id":16884,"path":"<INSTALL_DIR>\\runtime\\backend\\hyperboost_backend.exe","from_install":true},{"name":"hyperboost_backend","id":20376,"path":"<INSTALL_DIR>\\runtime\\backend\\hyperboost_backend.exe","from_install":true}] |
| token sync inferred | PASS | session_token_required=True; wpf_running=True |
| close installed app | PASS | [{"name":"HyperBoostX","id":16000,"path":"<INSTALL_DIR>\\HyperBoostX.exe","from_install":true},{"name":"hyperboost_backend","id":16884,"path":"<INSTALL_DIR>\\runtime\\backend\\hyperboost_backend.exe","from_install":true},{"name":"hyperboost_backend","id":20376,"path":"<INSTALL_DIR>\\runtime\\backend\\hyperboost_backend.exe","from_install":true}] |
