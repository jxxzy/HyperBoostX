...
{
    public partial class PlacementPageChrome : UserControl
    {
        public PlacementPageChrome()
        {
            InitializeComponent();
        }

        private async void RunPlacementAction_Click(object sender, RoutedEventArgs e)
        {
        ...
        private void SetActionButtonsEnabled(bool enabled)
        {
            ...
            if (RestoreActionItems != null)
                RestoreActionItems.IsEnabled = enabled;
        }
